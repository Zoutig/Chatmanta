// Kortlevend, slug-gebonden embed-token voor de V1-widget. Bewijst dat een
// chat/token-request van onze eigen /embed-v1-pagina komt zonder per-user auth.
//
// 1:1 port van lib/v0/server/embed-token.ts — zelfde wire-format, zelfde
// EMBED_TOKEN_SECRET, zelfde TTL-env (gedeeld secret). Eigen kopie i.p.v. import:
// het V0-bestand staat onder lib/v0/** (V1 leunt daar per conventie niet op) en is
// server-only. Identieke logica, geen gedragsverschil.
//
