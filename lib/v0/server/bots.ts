...
// Back-compat alias — RagConfig is the canonical type home in lib/rag/types.ts.
export type BotConfig = RagConfig;
...
const V0_1: BotConfig = {
  ...
  // V0 is single-bot per org — retrieval RPC does not receive p_chatbot_id.
  chatbotScoped: false,
