// Control Room — e2e smoke. Draait achter de auth-storageState uit global-setup.
...
const NAV = [
  ...
  '/controlroom/gesprekken',
  '/controlroom/bronnen',
  '/controlroom/jobs',
  '/controlroom/issues',
  '/controlroom/usage',
  '/controlroom/instellingen',
];
...
test.describe('Control Room', () => {
  ...
  test('profiel-edit persisteert', async ({ page }) => {
    await page.goto('/controlroom/klanten/globex-inc');
