'use client';
// V1 fork van V0's website-list.tsx — gewijzigde imports:
//   • WebsiteSource type uit ../types (V1)
//   • ManagedPages en CrawlDiagnostics uit lokale V1-forks
//   • CrawlProgress: import-only reuse van V0 (pure UI, geen data-seam)
// JSX/copy verbatim.
...
import { CrawlProgress } from '@/app/klantendashboard/kennisbank/components/crawl-progress';
