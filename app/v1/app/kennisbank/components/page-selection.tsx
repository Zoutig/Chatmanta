'use client';
// V1 fork van V0's page-selection.tsx — enige wijziging: MAX_CRAWL_PAGES uit
// @/lib/v1/crawler/firecrawl i.p.v. @/lib/v0/crawler/firecrawl. JSX/copy verbatim.
import { useState, type CSSProperties } from 'react';
import { ChevronRight, Search } from 'lucide-react';
import { groupPagesForDisplay, pathLabel } from '@/lib/v0/klantendashboard/group-pages';
import { MAX_CRAWL_PAGES } from '@/lib/v1/crawler/firecrawl';
