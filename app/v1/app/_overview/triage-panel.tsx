// TriagePanel (V1-fork van app/klantendashboard/components/overview/triage-panel).
// Identiek aan V0 — ALLEEN de twee hardcoded hrefs wijzen naar /v1/app/*. De
// UI-primitives (Btn/Icon) worden import-only uit V0 hergebruikt.
...
const UNANSWERED_HREF = '/v1/app/gesprekken?filter=unanswered';
const ADD_KNOWLEDGE_HREF = '/v1/app/kennisbank';
