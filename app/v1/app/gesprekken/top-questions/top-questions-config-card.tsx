...
// V1 "Meest gestelde vragen"-config: drempel + lijst-grootte.
//
// Verbatim port van V0's top-questions-config-card.tsx.
// Enige seam-wijziging: saveTopQuestionsConfigAction uit '../top-questions-actions'
// (V1 SA-1 pad) i.p.v. V0's '../../actions'.
...
export function TopQuestionsConfigCard({ initial }: { initial: TopQuestionsConfig }) {
  ...
  function save() {
    ...
    startTransition(async () => {
      const res = await saveTopQuestionsConfigAction(s);
      if (res.ok) {
