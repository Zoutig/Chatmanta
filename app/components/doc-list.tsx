  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
      <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-50">
        Geïndexeerde documenten ({docs.length})
      </h2>
      {docs.length === 0 ? (
  ...
  return (
    <li className="flex items-center justify-between gap-3 py-2 text-xs">
      ...
      <button
        ...
        onClick={onDelete}
        disabled={pending}
        className="rounded border border-zinc-300 px-2 py-1 text-zinc-600 hover:border-red-400 hover:text-red-600 disabled:opacity-50 dark:border-zinc-700 dark:text-zinc-400 dark:hover:border-red-700 dark:hover:text-red-400"
      >
        {pending ? '…' : 'Verwijder'}
      </button>
    </li>
